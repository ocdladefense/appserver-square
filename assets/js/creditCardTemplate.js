function creditCardTemplate(cardNumb,cardName,cardExp){
    if (cardNumb == null){
        cardNumb = '**** **** **** ****';
        cardName = 'GUEST';
        cardExp = '**/**'
    }
    return `<div class="creditcard container">
    <div class="front">
    <!--<i class="fab fa-cc-discover"></i>-->
        ...
        <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 750 471" style="enable-background:new 0 0 750 471;" xml:space="preserve">
            <g id="Front">
                ...
                <text transform="matrix(1 0 0 1 60.106 295.0121)" id="svgnumber" class="st2 st3 st4">${cardNumb}
                </text>
